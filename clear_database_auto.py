#!/usr/bin/env python3
"""
Script to clear all car registration data from the database automatically.
...
def clear_database():
    ...
    try:
        ...
        print(f"✅ Successfully cleared {current_count} registrations from the database")
...
if __name__ == "__main__":
    print("🗑️  Nord Stern Car Numbers - Database Clear Tool (Auto)")
    print("=" * 55)
