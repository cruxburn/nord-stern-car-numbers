...
def export_database_to_csv():
    ...
    try:
        ...
        with open(output_file, 'w', newline='') as f:
            ...
            # Write header
            writer.writerow([
                'id', 'first_name', 'last_name', 'car_number', 'sort_order', 'car_make', 
                'car_model', 'car_year', 'car_color', 'reserved_date', 'reserved_for_year', 
                'status', 'notes', 'last_usage_year', 'expiration_date', 'usage_count', 
        ...
        print(f"✅ Successfully exported {len(registrations)} registrations to {output_file}")
        return True
    ...
    try:
        ...
        with open(output_file, 'w') as f:
            ...
            for reg in registrations:
                ...
                f.write(f"INSERT INTO car_registrations VALUES ({', '.join(values)});\n")
