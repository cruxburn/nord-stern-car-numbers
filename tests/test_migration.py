...
class MigrationTestCase(unittest.TestCase):
    ...
    def test_migrate_sort_order_population(self):
        ...
        for first_name, last_name, car_number in test_data:
            self.cursor.execute('''
                ...
                VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?)
            ''', (first_name, last_name, car_number, "Test", "Model", 2020, "Red", None, "Test note"))
        ...
        for i, (car_number, sort_order) in enumerate(results):
            self.assertEqual(sort_order, expected_sort_orders[i], 
    ...
    def test_migrate_sort_order_invalid_numbers(self):
        ...
        expected_sort_orders = [1, 0, 14, 0]  # Valid numbers get their value, invalid get 0
